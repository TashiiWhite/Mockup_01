        ...
        <div className="grid items-center gap-12 lg:grid-cols-[0.9fr_1.4fr]">
          ...
          <div className="reveal">
            ...
            >
              ...
              />
              <span className="pointer-events-none absolute right-4 top-4 rounded-full bg-ivory/90 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-ink backdrop-blur">
              ...
              >
                <img
                  ...
                  draggable="false"
                  aria-hidden="true"
                  className="absolute inset-0 h-full w-full object-cover [filter:grayscale(0.6)_brightness(0.62)_contrast(0.9)]"
                />
                <div className="absolute inset-0 bg-ink/20" />
                <span className="pointer-events-none absolute left-4 top-4 rounded-full bg-ink/70 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-ivory backdrop-blur">
              ...
              {/* Handle */}
              <div
                className="absolute top-0 z-20 h-full w-0.5 bg-ivory/90"
              ...
              >
                <button
                  ...
                  className={`absolute left-1/2 top-1/2 flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 cursor-ew-resize items-center justify-center rounded-full bg-ivory text-ink shadow-luxe ring-1 ring-ink/10 transition-transform duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold ${
                    dragging ? 'scale-110' : 'hover:scale-105'
                  }`}
                >
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M15 18l-6-6 6-6" />
                    <path d="M9 6l6 6-6 6" opacity="0" />
                  </svg>
